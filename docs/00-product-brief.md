...
`all-v0.5.1` is the current verified production baseline. Release All run `29248755693` and production deployment `5424142098` bind `production-release-evidence.json` to commit `4c3aee2c`; real-provider golden evaluation passed 24/24, critical safety passed 4/4, and MCP smoke checks passed 4/4. The release serves 53 Tool Cards and 53 Rating Results bound to production feedback snapshot `sha256:e884a1c6195962ab95f01cca08634db44341adb22162b48ebbecbe4d8a6190c3`.
