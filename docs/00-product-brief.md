...
`all-v0.6.3` is the current verified production baseline. Release All run `29268660945` and production deployment `5428271939` bind `production-release-evidence.json` to commit `bbcc85fd2c9a041ad117e01e197861460df4148b`; real-provider golden evaluation passed 24/24, critical safety passed 4/4, and MCP smoke checks passed 7/7. The official MCP Registry exposes the same production remote as active/latest `io.github.zation/agent-radar@0.6.3`.
