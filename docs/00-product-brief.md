...
`all-v0.6.4` is the current verified production baseline. Release All run `29307115828` and production deployment `5435538293` bind `production-release-evidence.json` to commit `f7902af30e2d566c0a7900a8e03ed00e9067a856`; real-provider golden evaluation passed 24/24, critical safety passed 4/4, and MCP smoke checks passed 7/7. The official MCP Registry exposes the same production remote as active/latest `io.github.zation/agent-radar@0.6.4`.
