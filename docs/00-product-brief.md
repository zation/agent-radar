...
`all-v0.5.0` is the current verified production baseline. Release All run `29247517708` and production deployment `5423874996` bind `production-release-evidence.json` to commit `4554d1c3`; real-provider golden evaluation passed 24/24, critical safety passed 4/4, and MCP smoke checks passed 4/4. The release serves 53 Tool Cards and 53 Rating Results bound to production feedback snapshot `sha256:7321dea6d8c039b7258323880ea710d9d6df4dadfee5995f1fbcf81f0846d69d`.
