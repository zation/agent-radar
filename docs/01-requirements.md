...
- v0.6 pins `@modelcontextprotocol/server@2.0.0-beta.3`; `all-v0.6.4` passed the production evidence gates and its remote-only `io.github.zation/agent-radar@0.6.4` metadata was published through the evidence-bound GitHub OIDC workflow.
