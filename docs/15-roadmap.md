...
实际情况：MVP、v0.2、v0.3、v0.4、v0.5 和 v0.6 均已完成。`all-v0.6.3` 是当前已验证生产基线；Release All run `29268660945`、commit `bbcc85fd2c9a041ad117e01e197861460df4148b`、production deployment `5428271939`、24/24 real-provider golden eval、4/4 critical safety 和 7/7 MCP smoke 均已通过。Registry workflow run `29270224157` 已补齐可下载 publication evidence，官方 `io.github.zation/agent-radar@0.6.3` 记录为 active/latest。
...
- 当前状态：`all-v0.6.3` 已部署至 production；SDK handler、shared contracts/service、secret header 和七项 smoke 均已通过。官方 Registry 的 `io.github.zation/agent-radar@0.6.3` 为 active/latest，publication evidence 已上传。
...
- 完成证据：Release All run `29268660945`、deployment `5428271939`、Registry run `29270224157`；production artifact `agent-radar-mcp-smoke-29268660945` 与 Registry artifact `mcp-registry-publication-evidence-29268660945` 可下载核验。
