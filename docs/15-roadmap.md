...
实际情况：MVP、v0.2、v0.3、v0.4 和 v0.5 的开发均已完成。`all-v0.4.4` 仍是当前已验证生产基线；v0.5 的公开文档与 Golden Query 英文化已经完成本地实现和真实 provider 验证，下一步是通过 `all-v0.5.0` reviewed-bundle 流程完成生产发布。
