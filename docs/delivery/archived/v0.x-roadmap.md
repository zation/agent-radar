...
阶段 Spec：[`v0.3 P1：数据与可信度`](v0.3/2026-07-10-v0.3-p1-数据与可信度-设计.md)（已完成并冻结）。

阶段 Plan：[`v0.3 P1：数据与可信度实施计划`](v0.3/2026-07-10-v0.3-p1-数据与可信度-计划.md)（已完成并冻结）。
...
阶段 Spec：[`v0.3 P2：推荐安全与评测`](v0.3/2026-07-11-v0.3-p2-推荐安全与评测-设计.md)（已完成并冻结）。

阶段 Plan：[`v0.3 P2：推荐安全与评测实施计划`](v0.3/2026-07-11-v0.3-p2-推荐安全与评测-计划.md)（已完成并冻结）。
...
阶段 Spec：[`v0.4 P2：反馈处理与评级接入`](v0.4/2026-07-12-v0.4-p2-feedback-processing-rating-design.md)（已完成并冻结）。

阶段 Plan：[`v0.4 P2：反馈处理与评级接入实施计划`](v0.4/2026-07-12-v0.4-p2-feedback-processing-rating.md)（已完成并冻结）。
...
- [`v0.5 P1：公开文档英文化`](v0.5/2026-07-13-v0.5-p1-public-docs-english-design.md)（已完成）；对应 [`实施 Plan`](v0.5/2026-07-13-v0.5-p1-public-docs-english.md) 已冻结。
- [`v0.5 P2：Golden Query 英文化`](v0.5/2026-07-13-v0.5-p2-golden-query-english-design.md)（已完成）；对应 [`实施 Plan`](v0.5/2026-07-13-v0.5-p2-golden-query-english.md) 已冻结。
...
- Spec：[`v0.7 P1: Golden Query Token Usage Observability Design`](v0.7/2026-07-14-v0.7-p1-golden-query-token-usage-design.md)。
- Plan：[`v0.7 P1 Golden Query Token Usage Implementation Plan`](v0.7/2026-07-14-v0.7-p1-golden-query-token-usage.md)。
...
- Spec：[`v0.7 P2: Dynamic Skill Tool Card Expansion Design`](v0.7/2026-07-14-v0.7-p2-dynamic-skill-expansion-design.md)（Completed）。
- Plan：[`v0.7 P2 Dynamic Skill Expansion Implementation Plan`](v0.7/2026-07-14-v0.7-p2-dynamic-skill-expansion.md)（Completed；Inline Execution，直接在 `main` 开发）。
...
- Spec：[`v0.8 P1: Compact Recommendation Prompt Design`](v0.8/2026-07-15-v0.8-p1-compact-recommendation-prompt-design.md)。
- Plan：[`v0.8 P1 Compact Recommendation Prompt Implementation Plan`](v0.8/2026-07-15-v0.8-p1-compact-recommendation-prompt.md)。
...
- Web UI 视觉与交互 Spec：[`v0.4 P1：Web UI 视觉与交互重构`](v0.4/2026-07-11-v0.4-p1-web-ui-视觉与交互重构-设计.md)（已完成并冻结）。
- Web UI 实施 Plan：[`v0.4 P1 Web UI 视觉与交互重构`](v0.4/2026-07-11-v0.4-p1-web-ui-视觉与交互重构.md)（已完成）。
- UI 可维护性 Spec：[`v0.4 UI：shadcn + Tailwind 可维护性重构`](v0.4/2026-07-11-v0.4-ui-shadcn-tailwind-maintainability-设计.md)（已完成，实现提交 `6ca864a7`）。
- UI 可维护性 Plan：[`v0.4 UI shadcn + Tailwind 可维护性重构`](v0.4/2026-07-11-v0.4-ui-shadcn-tailwind-maintainability.md)（已完成，实现提交 `6ca864a7`）。
- P1 UI 重构与反馈写链路已由 `all-v0.4.1` 完成生产验收。
- P1 Feedback Spec：[`v0.4 P1 GitHub Feedback`](v0.4/2026-07-12-v0.4-p1-github-feedback-design.md)（已完成，实现提交 `086c28bb`、`293b4940`、`0317362f`）。
- P1 Feedback Plan：[`v0.4 P1 GitHub Feedback Implementation Plan`](v0.4/2026-07-12-v0.4-p1-github-feedback.md)（已完成，实现提交 `086c28bb`、`293b4940`、`0317362f`）。
- P2 Spec：[`v0.4 P2：反馈处理与评级接入`](v0.4/2026-07-12-v0.4-p2-feedback-processing-rating-design.md)（已完成并冻结）。
- P2 Plan：[`v0.4 P2：反馈处理与评级接入实施计划`](v0.4/2026-07-12-v0.4-p2-feedback-processing-rating.md)（已完成并冻结）。
- P2 已由 `all-v0.4.4` 完成生产验收；三态 Issue 处理、投票快照和 `feedback_rules.v0.1` 已接入 `Release All` 的 reviewed bundle 构建。

### v0.5：公开内容与评测数据英文化

- P1 Spec：[`v0.5 P1：公开文档英文化`](v0.5/2026-07-13-v0.5-p1-public-docs-english-design.md)（已完成）；对应 [`实施 Plan`](v0.5/2026-07-13-v0.5-p1-public-docs-english.md) 已冻结。
- P2 Spec：[`v0.5 P2：Golden Query 英文化`](v0.5/2026-07-13-v0.5-p2-golden-query-english-design.md)（已完成）；对应 [`实施 Plan`](v0.5/2026-07-13-v0.5-p2-golden-query-english.md) 已冻结。
...
- Spec：[`v0.6：官方 MCP TypeScript SDK 与 Registry 发布设计`](v0.6/2026-07-13-v0.6-official-mcp-sdk-registry-design.md)（Completed；已冻结）。
- Plan：[`v0.6 Official MCP SDK and Registry Publication Implementation Plan`](v0.6/2026-07-13-v0.6-official-mcp-sdk-registry.md)（Completed；Tasks 1–10 已完成并冻结）。
...
- P1 Spec：[`v0.7 P1: Golden Query Token Usage Observability Design`](v0.7/2026-07-14-v0.7-p1-golden-query-token-usage-design.md)（Completed；已冻结）。
- P1 Plan：[`v0.7 P1 Golden Query Token Usage Implementation Plan`](v0.7/2026-07-14-v0.7-p1-golden-query-token-usage.md)（Completed；已冻结）。
...
- P2 Spec：[`v0.7 P2: Dynamic Skill Tool Card Expansion Design`](v0.7/2026-07-14-v0.7-p2-dynamic-skill-expansion-design.md)（Completed；已冻结）。
- P2 Plan：[`v0.7 P2 Dynamic Skill Expansion Implementation Plan`](v0.7/2026-07-14-v0.7-p2-dynamic-skill-expansion.md)（Completed；Inline Execution；已冻结）。
...
- P1 Spec：[`v0.8 P1: Compact Recommendation Prompt Design`](v0.8/2026-07-15-v0.8-p1-compact-recommendation-prompt-design.md)（Completed；已冻结）。
- P1 Plan：[`v0.8 P1 Compact Recommendation Prompt Implementation Plan`](v0.8/2026-07-15-v0.8-p1-compact-recommendation-prompt.md)（Completed；已冻结）。
...
- P1 Spec：[`v0.9 P1: Installable Agent Radar Skill Design`](v0.9/2026-07-16-v0.9-p1-installable-agent-radar-skill-design.md)（Superseded；无实现提交）。
- P1 Plan：[`v0.9 P1 Installable Agent Radar Skill Implementation Plan`](v0.9/2026-07-16-v0.9-p1-installable-agent-radar-skill.md)（Superseded；无实现提交）。
- P2 Spec：[`v0.9 P2: Local-First Versioned Skill Dataset Design`](v0.9/2026-07-16-v0.9-p2-local-first-skill-dataset-design.md)（Completed；实现提交 `0846e592`；已冻结）。
- P2 Plan：[`v0.9 P2 Local-First Skill Dataset Implementation Plan`](v0.9/2026-07-16-v0.9-p2-local-first-skill-dataset.md)（Completed；实现提交 `0846e592`；已冻结）。
...
- P3 状态：Completed and production-verified；实现提交 `4a16e37d`，发布提交 `60d289bd`。独立 [`v0.9 P3 Release Identity Convergence Design`](v0.9/2026-07-16-v0.9-p3-release-identity-convergence-design.md) 与 [`Implementation Plan`](v0.9/2026-07-16-v0.9-p3-release-identity-convergence.md) 已完成并冻结；P2 Spec/Plan 保持冻结。
