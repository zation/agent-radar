...
- 完整的人工审核 UI，以及 promotion candidates 到可靠发布 artifacts 的人工提升流程；当前 preview review markdown 已展示 approval request、release admission blocked reasons、promotion candidate 明细、seed candidate snippet 路径和 promotion plan 人工合并提示。
