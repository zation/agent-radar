...
`all-v0.4.4` is the current verified production baseline. Release All run `29226907250`, commit `0b9fc48c`, and deployment `5419806444` bind the reviewed bundle and production evidence; 53 reliable Tool Cards, real-provider golden evaluation 24/24, critical safety 4/4, and deployed `/api/mcp` smoke 4/4 passed.
